                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" name="content" required="required" class="form-control col-md-7 col-xs-12"
                                   value=${lBill!=null?lBill.content:""}>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <textarea name="remark" class="form-control col-md-7 col-xs-12" required="required">${lBill!=null?lBill.remark:""}</textarea>
                        </div>
                    </div>
