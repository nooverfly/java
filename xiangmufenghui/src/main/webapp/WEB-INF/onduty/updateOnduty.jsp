    ...
    <div class="right_col" role="main">
        <div class="">
            <div class="page-title">
                <a href="#" class="btn btn-primary btn-xs" onclick="formSubmit('updateOnduty','_self');this.blur();"><i class="fa fa-folder"></i> 保存</a>
                        ...
                        <div class="x_content">
                            ...
                            <table class="table table-striped projects" style="width: 98%">
                                ...
                                <tr hidden="hidden">
                                    ...
                                    <td><input type="text" name="ondutyId"  value="${ ondutyId }"></td>
                                </tr>
                                    ...
                                    <td>
                                        <input type="text" style="width:120px;" name="ondutyTime"
                                               onclick="WdatePicker({el:this,isShowOthers:true,dateFmt:'yyyy-MM-dd'});"
                                                value= "<fmt:formatDate value="${ onduty.ondutyTime }" pattern="yyyy-MM-dd"/>"/>
                                    </td>
                                </tr>

                                <tr>
                                    <td style="width: 30%">领班负责人</td>
                                    <td><input type="text" name="ondutyLeader"  value="${ onduty.ondutyLeader }"></td>
                                </tr>
                                <tr>
                                    <td style="width: 30%">值班人数</td>
                                    <td><input type="text" name="ondutyNum" value="${ onduty.ondutyNum }"></td>
                                </tr>
                                <tr>
                                    <td>备注</td>
                                    <td><textarea name="remark" >${ onduty.remark }</textarea></td>
                                </tr>
