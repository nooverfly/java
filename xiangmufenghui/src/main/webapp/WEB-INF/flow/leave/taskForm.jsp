...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <br />
                <form action="submitTask.action" data-parsley-validate class="form-horizontal form-label-left">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">批&emsp;&emsp;注 <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <textarea name="comment" class="form-control col-md-7 col-xs-12" required="required"></textarea>
                        </div>
                    </div>
                    <div class="ln_solid">
                        <span style="color: #0f0f0f">同意</span><input type="radio" name="yj" value="同意"></input>
                        <span style="color: #0f0f0f">驳回</span><input type="radio" name="yj" value="驳回"></input>
                    </div>
                    <div class="ln_solid">
